...
export function EventCard({ event, stats, isOwner, teams = [] }: {
  event: any
  stats?: { total: number; done: number; teams: number }
  isOwner?: boolean
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: '20px 22px' }}>
        ...
        {/* Footer */}
        <div className="event-card-footer" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', paddingTop: '14px', borderTop: '1px solid rgba(232,184,75,0.08)', gap: '8px', flexWrap: 'wrap' }}>
