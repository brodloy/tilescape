  ...
  return (
    <div className="min-h-screen bg-bg">
      ...
      <AppNav
        ...
        context={
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <span style={{ fontFamily: "'Syne',sans-serif", fontWeight: 700, fontSize: '14px', color: 'var(--text)' }}>New Event</span>
          </div>
        }
      />
      ...
      <main className="max-w-2xl mx-auto px-6 py-14 relative z-10">
        <div className="mb-10">
          <div className="font-pixel text-[9px] text-gold tracking-widest mb-3 opacity-80">CREATE EVENT</div>
        ...
        <div className="bg-surface border border-[rgba(232,184,75,0.12)] rounded-xl overflow-hidden">
          <div className="px-6 py-4 border-b border-[rgba(232,184,75,0.10)]">
            <span className="font-pixel text-[9px] text-gold tracking-widest">EVENT DETAILS</span>
          </div>
          <div className="p-6">
            <form action={createEventVoid} className="space-y-5">
              <div>
                <label className="block font-pixel text-[9px] text-text-2 tracking-wider mb-2 uppercase">Event Name</label>
              ...
              <div>
                <label className="block font-pixel text-[9px] text-text-2 tracking-wider mb-2 uppercase">Description <span className="text-text-3">(optional)</span></label>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block font-pixel text-[9px] text-text-2 tracking-wider mb-2 uppercase">Start Date</label>
                ...
                <div>
                  <label className="block font-pixel text-[9px] text-text-2 tracking-wider mb-2 uppercase">End Date</label>
                  <input name="end_date" type="datetime-local"
                    className="w-full h-12 px-4 rounded bg-bg3 border border-[rgba(232,184,75,0.20)] text-text text-sm outline-none focus:border-gold-dim transition-all" />
                </div>
              </div>
              <div>
                <label className="block font-pixel text-[9px] text-text-2 tracking-wider mb-2 uppercase">Discord Webhook URL</label>
